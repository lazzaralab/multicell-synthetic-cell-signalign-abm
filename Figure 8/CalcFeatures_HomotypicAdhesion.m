...
feature_name = ["a-count"; "b-count";"c-color-count"; "c-express-count"; "d-color-count"; "d-express-count";"cell-count"; 
    ...
    "green_red_centroid_dist";"green_region_avg_red_contig"; "red_region_avg_green_contig"; "green_red_contig_dif";"green_region_circularity";"red_region_circularity";
...
%                 green_region_i_circularity = circularity(green_region_i_boundary);
                red_border = sum(green_region_i_boundary & img_red,"All");
                ap = red_border / green_diam;
%                 green_circ = [green_circ green_region_i_circularity];
            ...
            [large_green_region_i_boundary,green_diam] = findregionboundary(img_green,img_core);
...
%                 red_region_i_circularity = circularity(red_region_i_boundary);
                green_border = sum(red_region_i_boundary & img_green,"All");
                ap = green_border / red_diam;
%                 red_circ = [red_circ red_region_i_circularity];
                red_contig = [red_contig ap];
            end
            core = table_red(table_red.Area == max(table_red.Area),:);
            img_core = core.PixelList;
            img_core = img_core{1,1};
            [large_red_region_i_boundary,red_diam] = findregionboundary(img_red,img_core);
            red_region_circularity = circularity(large_red_region_i_boundary);
            ...
            col_features = [col_features; green_region_avg_red_contig; red_region_avg_green_contig; green_red_contig_dif; green_region_circularity; red_region_circularity];
        else
