...
feature_name = ["a-count"; "b-count";"c-color-count"; "c-express-count"; "d-color-count"; "d-express-count";"cell-count"; 
    "num_green_regions"; "num_large_green_regions";"num_lone_green_regions"; "green_avg_regionArea_fract"; "green_area_fract"; "green_avg_cent_dist";"green_region_width";"green_region_height"; "green_region_aspect_ratio";"green_region_circularity";
    "num_red_regions"; "num_large_red_regions"; "num_red_lone"; "red_avg_regionArea_fract"; "red_area_fract"; "red_avg_cent_dist";"red_region_width";"red_region_height"; "red_region_aspect_ratio";"red_region_circularity";
...
for k = 1:length(files)
    ...
    %   ----------------------Green Region Data---------------------------
        ...
        num_large_green_regions = sum(table_green.Area > 15);
        num_green_lone = sum(table_green.Area <= thresh);
        col_features = [col_features; num_green_regions; num_large_green_regions; num_green_lone];
    ...
    %   ----------------------Red Region Data---------------------------
        ...
        num_large_red_regions = 0;
        num_large_red_regions = sum(table_red.Area > 15);
        if num_large_green_regions > 0 && num_large_red_regions > 0
            disp(run);
            num_large_green_regions=0;
            num_large_red_regions=0;
        end
        num_red_lone = sum(table_red.Area <= thresh);
        col_features = [col_features; num_red_regions;num_large_red_regions; num_red_lone];
...
%         if num_green_regions == 0
%             core = "red";
%             col_features = [col_features; core];
%         elseif num_red_regions == 0
%             core = "green";
%             col_features = [col_features; core];
%         elseif num_red_regions > 2
%             core = "green";
%             col_features = [col_features; core];
%         elseif num_green_regions > 2
%             core = "red";
%             col_features = [col_features; core];
        ...
        conditions = [conditions; repmat(condition, length(feature_name),1)];
        feature_names=[feature_names;feature_name];
    end
end
    features = [ratios, radii, conditions,feature_names, features];
